...
var.names <- c("Elevation30SNV", "Slope30SNV", "TRI30SNV", "NDVICVMeanMax1989_2015SNV",
               "NDVIMeanMax1989_2015SNV", "Precip0609SNV",  "Precip1005SNV", "Tmin01",
               "Tmax07SNV", "SnowFreeDaysSNV", "Aspen30m", "Conifer30m","Meadow30m",
               "Mixed30m", "Rock30m", "Shrub30m") 
